...
namespace AssimpSample
{
    ...
    public class World : IDisposable
    {
        ...
        private void SetupLighting(OpenGL gl)
        {
            ...
            float[] amb_comp = {0.3f, 0.3f, 0.3f, 1.0f };
            float[] diff_comp = { 0.7f, 0.7f, 0.7f, 1.0f };
        ...
        public void DrawWalls(OpenGL gl)
        {
            ...
            gl.Translate(0f, 30f, -480f);
            gl.Scale(600f, 280f, 20f);
            Cube cube = new Cube();
            ...
            gl.Translate(580f, 30f, 0f);
            gl.Scale(20f, 280f, 460f);
            cube.Render(gl, RenderMode.Render);
            gl.PopMatrix();
            //Levi zid
            gl.PushMatrix();
        ...
        public void DrawCage(OpenGL gl)
        {
            ...
            gl.Translate(0f, 55f, 0f);
            gl.Color(0.3f, 0.3f, 0.3f);
            cage.CreateInContext(gl);
            cage.NormalGeneration = Normals.Flat;
