    ...
    public partial class MainWindow : Window
    {
        ...
        private void Window_KeyDown(object sender, KeyEventArgs e)
        {
            switch (e.Key)
            {
                ...
                case Key.Up: m_world.RotationX -= 7.0f; break;
                case Key.Down: m_world.RotationX += 7.0f; break;
                case Key.Left: m_world.RotationY -= 7.0f; break;
                case Key.Right: m_world.RotationY += 7.0f; break;
                case Key.Add: m_world.SceneDistance -= 250.0f; break;
                case Key.Subtract: m_world.SceneDistance += 250.0f; break;
                case Key.F2:
